...
from utils_stream import classes_and_models, update_logger
...
st.title("Welcome to License Plate Recognition API 🚘 🛵")
...
choose_model = st.sidebar.selectbox(
    ...
    ("Model 1 (UFPR Brazil)", # original 10 classes
...
# Model choice logic
if choose_model == "Model 1 (UFPR Brazil)":
...
if session_state.pred_button:
    ...
    session_state.pred_conf = "NA" #hardcoded
    # st.write(f"Prediction: {session_state.pred_class}, \
    #            Confidence: {session_state.pred_conf}")
    st.write(f"Prediction: {session_state.pred_class}")
